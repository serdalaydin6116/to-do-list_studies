...
const completedTaskCount = () =>{
    ...
    const checkedTasks =document.getElementById("checkedTasks"); //function dışına cıkınca da erieşebilmek için const ile tanımladık
...
//delete task  (birşeyi kontrol ve condition)
